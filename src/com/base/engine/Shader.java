...
public class Shader {
	...
	public Shader() {
		...
		if (program == 0) {
			System.out.println("Shader creation failed: Could not find valid memory locaiton in constructor");
			System.exit(1);
		}
	}
	...
	private void addProgram(String text, int type) {
		...
		if (shader == 0) {
			System.out.println("Shader creation failed: Could not find valid memory locaiton when adding shader");
			System.exit(1);
		}
