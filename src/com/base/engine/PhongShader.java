...
public class PhongShader extends Shader {
	...
	public static void setPointLight(PointLight[] pointLights) {
		if (pointLights.length > MAX_POINT_LIGHTS) {
			System.err.println("Error: You passed in too many point lights. Max allowed it " + MAX_POINT_LIGHTS + ", you passed in " + pointLights.length);
	...
	public static void setSpotLight(SpotLight[] spotLights) {
		if (spotLights.length > MAX_SPOT_LIGHTS) {
			System.err.println("Error: You passed in too many spot lights. Max allowed it " + MAX_SPOT_LIGHTS + ", you passed in " + spotLights.length);
			new Exception().printStackTrace();
			System.exit(1);
		} 
	...
	public void setUniform(String uniformName, DirectionalLight diretionalLight) {
